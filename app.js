...
var myUser = { id: 1, name: "Jane Doe", age: 25 };
...
var Car = /** @class */ (function (_super) {
    ...
    Car.prototype.drive = function () {
        console.log("Driving my ".concat(this.brand, " ").concat(this.model));
    };
    return Car;
}(Vehicle));
...
function logged(target) {
    console.log("Class ".concat(target.name, " has been defined."));
}
